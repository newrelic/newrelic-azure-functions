...
param activityLogsDiagnosticSettingName string 
...
resource activityLogsDiagnosticSetting 'Microsoft.Insights/diagnosticSettings@2017-05-01-preview' = {
  name: activityLogsDiagnosticSettingName
  properties: {
